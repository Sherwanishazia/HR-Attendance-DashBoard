...
HR-Attendance DashBoard Using Power BI and Excel.
The HR Attendance Dashboard provides an in-depth look at employee attendance, enabling HR managers and leadership to monitor workforce participation trends, identify absenteeism patterns, and ensure business continuity. 
...
**Work from Home (WFH) Count:**
    This feature tracks the total number of employees who opted for WFH on any given day. With the growing hybrid work culture, this         metric provides visibility into how employees balance in-office and remote work.
**Sick Leave (SL) Count:**
...
Actionable Insights:
-  The dashboard empowers HR teams with the ability to track attendance patterns over time. Identifying frequent absences, high WFH         usage, or sick leave trends could signal the need for policy updates or health interventions.
